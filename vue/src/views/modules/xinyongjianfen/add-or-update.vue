<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="信用分" prop="xinyongfen">
          <el-input v-model="ruleForm.xinyongfen" 
              placeholder="信用分" clearable  :readonly="ro.xinyongfen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="信用分" prop="xinyongfen">
              <el-input v-model="ruleForm.xinyongfen" 
                placeholder="信用分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
          ...
          if(o=='xinyongfen'){
            this.ruleForm.xinyongfen = obj[o];
	    this.ro.xinyongfen = true;
            continue;
          }
          if(o=='beizhu'){
        ...
        this.ruleForm.xinyongfen = 0
	this.ro.xinyongfen = false;
      }
      // 获取用户信息
      this.$http({
    ...
    onSubmit() {
      ...
      if(obj!=null) {
	      obj.xinyongfen = obj.xinyongfen - this.ruleForm.xinyongfen
	      if(obj.xinyongfen<0){
		this.$message.error("信用分不足");
		return
	      }
	      this.$http({
		  url: `${table}/update`,
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xinyongjianfen/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xinyongjianfenCrossAddOrUpdateFlag = false;
                  this.parent.search();
