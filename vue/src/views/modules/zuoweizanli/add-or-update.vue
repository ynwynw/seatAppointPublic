    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="暂离原因" prop="zanliyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="暂离原因"
                  v-model="ruleForm.zanliyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zanliyuanyin" label="暂离原因" prop="zanliyuanyin">
                    <span>{{ruleForm.zanliyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.likaishijian = true;
          ...
          if(o=='zanliyuanyin'){
            this.ruleForm.zanliyuanyin = obj[o];
	    this.ro.zanliyuanyin = true;
            continue;
          }
          if(o=='xuehao'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zuoweizanli/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zuoweizanliCrossAddOrUpdateFlag = false;
                  this.parent.search();
